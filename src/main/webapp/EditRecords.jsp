...
<%
	...
	<input type="text" name="id" value="<%=records.getId() %>" hidden="true" required/th>
		<fieldset>
			<table>
				<tr>
					<th>Name:</th>
					<th><input type="text" name="name" required="required" value="<%=records.getName()%>"></th>
				</tr>
				<tr>
					<th>Email:</th>
					<th><input type="email" name="email" required="required" value="<%=records.getEmail() %>"></th>
				</tr>
				<tr>
					<th>Mobile</th>
					<th><input type="number" name="mobile" required="required" value="<%=records.getMobile() %>"></th>
				</tr>
				<tr>
					<th>Maths:</th>
					<th><input type="text" name="maths" required="required" value="<%=records.getMaths() %>"></th>
				</tr>
				<tr>
					<th>Science:</th>
					<th><input type="text" name="science" required="required" value="<%=records.getScience() %>"></th>
				</tr>
				<tr>
					<th>English:</th>
					<th><input type="text" name="english" required="required" value="<%=records.getEnglish() %>"></th>
				</tr>
				<tr>
